...
use db\exception\ValidateException;
use db\model\relation\BelongsTo;
use db\model\relation\BelongsToMany;
use db\model\relation\HasMany;
use db\model\relation\HasManyThrough;
use db\model\relation\MorphMany;
use db\model\relation\MorphOne;
use db\model\relation\MorphTo;
    ...
    protected function buildQuery()
    {
        ...
        if (!empty($this->connection)) {
            if (is_array($this->connection)) {
                $connection = array_merge($this->options['database'], $this->connection);
            } else {
